...
import common.extern.utils.Json.KilcoteJSONReader;
import common.extern.utils.Json.KilcoteJSONWriter;
import common.extern.utils.xml.KilcoteOutputFormat;
import common.extern.utils.xml.KilcoteXMLSerializer;
...
public class mapping_Model
{
	...
	protected String get_XmlFromXmlNode(Node node) throws Throwable {
		String result = null;
		if(node!=null) {
			KilcoteXMLSerializer serial;
			if(node instanceof Document) {
				KilcoteOutputFormat of = new KilcoteOutputFormat((Document)node);
				of.setOmitXMLDeclaration(true);
				serial = new KilcoteXMLSerializer(of);
			}
			else {
				KilcoteOutputFormat of = new KilcoteOutputFormat();
				of.setOmitXMLDeclaration(true);
				serial = new KilcoteXMLSerializer(of);
			}
	...
	protected HashMap get_HashMapFromString(String info) throws Throwable {
		...
		try {
			if(info!=null) {
				KilcoteJSONReader reader = new KilcoteJSONReader();
