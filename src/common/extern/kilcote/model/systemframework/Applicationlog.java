package common.extern.kilcote.model.systemframework;
...
public class Applicationlog
{
	 ...
	 * @since ModelWeb 1.0
	 */
	public static void LogKilCote(String strMessage) {
		StringBuffer buffer = new StringBuffer("");
		try {
			buffer.append("===========================KilCote==========================");
	 ...
	 * @since ModelWeb 1.0
	 */
	public static void LogKilCoteError(String strMessage) {
		StringBuffer buffer = new StringBuffer("");
		try {
			buffer.append("===========================KilCote==========================");
			buffer.append("Error occur:\r\n");
	 ...
	 * @since ModelWeb 1.0
	 */
	public static void LogKilCoteError(Throwable ex) {
		StringBuffer buffer = new StringBuffer("");
		try {
			buffer.append("===========================KilCote==========================");
			if (ex.getStackTrace() != null) {
	 ...
	 * @since ModelWeb 1.0
	 */
	public static void LogKilCoteError(Throwable ex, String strSql) {
		StringBuffer buffer = new StringBuffer("");
		try {
			buffer.append("===========================KilCote==========================");
			buffer.append("\r\n\r\n");
	...
	public static void LogKilCoteError(String strErrorMsg, String strSql) {
		StringBuffer buffer = new StringBuffer("");
		try {
			buffer
					.append("===========================KilCote==========================");
