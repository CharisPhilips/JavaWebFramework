package common.extern.kilcote.model.model.result;

import common.extern.kilcote.model.error.KilcoteException;
import common.extern.kilcote.model.error.dataaccess.KilcoteDBAcessException;
...
public class univeralResult {
	...
	public void setErrorMsg(KilcoteException ex) {
		setErrorMsg((Throwable)ex);
		m_nResult = ex.getErrorCode();
		m_strErrorMsg += "Error code:" + ex.getErrorCode() + "\r\n";
	}
	public void setErrorMsg(KilcoteDBAcessException ex) {
		setErrorMsg((KilcoteException)ex);
