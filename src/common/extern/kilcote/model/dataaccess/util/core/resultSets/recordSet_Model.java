package common.extern.kilcote.model.dataaccess.util.core.resultSets;
...
import common.extern.kilcote.model.dataaccess.mvc.base.item_Model;
import common.extern.kilcote.model.dataaccess.mvc.base.tbl_Model;
...
import common.extern.kilcote.model.dataaccess.util.core.query.queryProducts.sqlRelationItems.selectSetItem;
...
public abstract class recordSet_Model {
	...
	/***Table(Field)Itme name*/
	protected IItem_Model m_ItemModel = null;
	/**Command Type(statement)*/
	...
	private void Debug_Query(String strSql) {
		if(Applicationlog.IS_DEBUG) {
			...
			Applicationlog.LogKilCote(strSql);
		}
	}
	/**
	 * @throws SQLException
...
/** ***************************Getter and Setter******************************** */
	...
	/**
	 * prepareStatementObject long type set
	 * @param nParameterIndex parameter Index
	 * @param obj
	 * @return
	 * @throws SQLException
	 * @author kil cote
