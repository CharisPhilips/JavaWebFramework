package common.extern.kilcote.model.dataaccess.util.core.connections.storeconnect;

import java.sql.Connection;
import java.util.Vector;

import common.extern.kilcote.model.dataaccess.util.core.connections.ConnectSourceModel;
import common.extern.kilcote.model.dataaccess.util.core.connections.configDB_Model;
...
public class storeConnect extends ConnectSourceModel{
	...
	public Connection getConnection() throws Throwable { 
		try {
			if(m_vcConn!=null) {
				...
				Applicationlog.LogKilCoteError("Database Connection Object Error...");
				return null;
			}
		}
		catch (Exception ex) 	{
	...
	private synchronized Connection GetCurConnection() {
		try {
			...
			Applicationlog.LogKilCoteError("Current Database Connection Object Getting Error" + ex.getMessage());
		}
		return null;
	}
