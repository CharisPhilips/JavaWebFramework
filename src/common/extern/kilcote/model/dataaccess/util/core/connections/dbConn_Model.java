package common.extern.kilcote.model.dataaccess.util.core.connections;

import java.sql.Connection;
import java.util.Vector;

import common.extern.kilcote.model.dataaccess.util.core.connections.closeconnect.closeConnect;
import common.extern.kilcote.model.dataaccess.util.core.connections.storeconnect.storeConnect;
...
public class dbConn_Model {
	...
	public synchronized Connection getConnection() 	{
		...
		try { result = m_connectSource.getConnection(); }
			...
			Applicationlog.LogKilCoteError("Database connection error...");
			Applicationlog.LogKilCoteError(ex);
			return null;
		}
		return result;
	}
	...
	public void closeConnection(Connection objConn) {
		try {
			...
			Applicationlog.LogKilCoteError("Database close error...");
			Applicationlog.LogKilCoteError(ex);
		}
	}
