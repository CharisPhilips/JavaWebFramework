...
import common.extern.kilcote.model.model.result.univeralResult;
import common.extern.kilcote.model.rule.mvc.apply.KilCoteRule;
import common.extern.kilcote.model.rule.mvc.apply.inter.IKilCoteRule;
public class KilcoteBusiness extends BaseBusiness implements IKilCoteRule
{
	public KilcoteBusiness(facadeFatherModel parentFacade, dbConn_Model dbConnModel, IItem_Model itemModel, pageModel pageModel) {
		super(parentFacade, null, null, itemModel);
		m_daClient = new KilcoteDA(dbConnModel, itemModel);
		m_ruleClient = new KilCoteRule(this, m_daClient, itemModel, pageModel);
	}
	...
	private KilCoteRule m_ruleClient = null; 
	private KilcoteDA m_daClient = null;
	...
	public univeralResult GetDistinctListbyEqu(int nDistinctField, whereExpressionRelation whereList, boolean bAndOr, orderExpressionRelation orderList, Object pageInfo) {
		...
		catch(KilcoteException ex){ result.setErrorMsg(ex); result.setResultObj(ex.getErrorCode()); }	
		catch(Throwable ex){ result.setErrorMsg(ex); }
		return result;
	}
	/**
	...
	/**********************implements mapping**************************/
	@Override
	protected IKilCoteRule getRuleClient() {
		return m_ruleClient;
	}
	@Override
