...
public class KilcoteOutputFormat
{
    ...
    public KilcoteOutputFormat(String method, String encoding, boolean bIndenting) {
    	if(m_bExternalOrgAXSOExist) {
    ...
    public KilcoteOutputFormat(Document document) {
    	if(m_bExternalOrgAXSOExist) {
    ...
    public KilcoteOutputFormat(Document document, String encoding, boolean bIndenting) {
    	if(m_bExternalOrgAXSOExist) {
