...
public class KilcoteXMLSerializer
{
	...
	public KilcoteXMLSerializer(KilcoteOutputFormat outputformat) {
		if(m_bExternalOrgAXSXExist) {
    ...
    public KilcoteXMLSerializer(Writer writer, KilcoteOutputFormat outputformat)
    {
    	if(m_bExternalOrgAXSXExist) {
    		Object output = outputformat.getOutputFormat();
    		if(output!=null) {
    ...
    public void setOutputFormat(KilcoteOutputFormat outputformat)
    {
    	if(m_bExternalOrgAXSXExist) {
    		Object output = outputformat.getOutputFormat();
    		if(output!=null) {
